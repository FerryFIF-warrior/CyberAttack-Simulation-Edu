...
<article class="cat-card group overflow-hidden transition hover:border-cat-cyan/40">
    <div class="h-36 bg-gradient-to-br from-cat-cyan/15 via-cat-surface to-cat-bg">
    ...
    <div class="space-y-3 p-5">
        ...
        <a href="{{ route('simulasi.detail', ['simulation' => $lab['slug']]) }}" class="cat-btn-ghost w-full justify-between">
            {{ $lab['lab_cta'] }}
